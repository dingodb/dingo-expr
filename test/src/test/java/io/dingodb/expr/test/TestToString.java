...
public class TestToString {
    ...
    private static @NonNull Stream<Arguments> getParameters() {
        return Stream.of(
            ...
            arguments("bytes('abc')", "CASTBYTES('abc')"),
    ...
    private static @NonNull Stream<Arguments> getParameters1() {
        return Stream.of(
            ...
            //    "(CASTDOUBLE($[0]) + CASTDOUBLE($[2]) + $[1])*MAX(CASTDOUBLE($[0]), $[1])"),
            ...
            arguments("bool(null) && c", "CASTBOOL(NULL) && $[2]"),
            arguments("c && bool(null)", "$[2] && CASTBOOL(NULL)"),
            arguments("true || c", "true || $[2]"),
            arguments("c || true", "$[2] || true"),
            arguments("false || c", "false || $[2]"),
            arguments("c || false", "$[2] || false"),
            ...
            arguments("array(1, 2.0, 3)", "ARRAY(CASTDECIMAL(1), 2.0, CASTDECIMAL(3))"),
            arguments("list(1, 2.0, 3)", "LIST(CASTDECIMAL(1), 2.0, CASTDECIMAL(3))")
        );
    }
    ...
    private static @NonNull Stream<Arguments> getParameters2() {
        return Stream.of(
            ...
            arguments("and(true, null, a, b, c)", "AND(BOOL(NULL), CASTBOOL($[0]), CASTBOOL($[1]), $[2])"),
