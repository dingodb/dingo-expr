...
public final class OpKeys {
    ...
    public static final BinaryOpKeys DATE_INT = new BinaryOpKeys(Types.DATE, Types.INT);
    public static final BinaryOpKeys TIMESTAMP_INT = new BinaryOpKeys(Types.TIMESTAMP, Types.INT);
