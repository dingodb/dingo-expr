...
abstract class LtOp extends RelationalOp {
    ...
    static boolean lt(@NonNull Date value0, Date value1, ExprConfig config) {
    ...
    static boolean lt(@NonNull Time value0, Time value1, ExprConfig config) {
        /*DingoTimeZoneProcessor processor = config.getProcessor();
    ...
    static boolean lt(@NonNull Timestamp value0, Timestamp value1, ExprConfig config) {
        /*DingoTimeZoneProcessor processor = config.getProcessor();
