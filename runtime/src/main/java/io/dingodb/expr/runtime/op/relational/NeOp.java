...
@Operators
abstract class NeOp extends RelationalOp {
    private static final long serialVersionUID = 5463300749103719924L;
    ...
    static boolean ne(@NonNull Date value0, Object value1) {
    ...
    static boolean ne(@NonNull Timestamp value0, Object value1) {
        if (value1 instanceof Timestamp) {
            ...
            return !dateValue0.equals((Date)value1);
        }
        return false;
    }
