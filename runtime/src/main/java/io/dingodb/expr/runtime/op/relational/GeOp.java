...
@Operators
abstract class GeOp extends RelationalOp {
    private static final long serialVersionUID = -928770083283805909L;
    ...
    static boolean ge(boolean value0, boolean value1) {
        return value0 || !value1;
    }
    ...
    static boolean ge(@NonNull Date value0, Object value1) {
        if (value1 instanceof Date) {
            return !value0.before((Date) value1);
            ...
            return !value0.before(dateValue1);
        } else {
            return false;
        }
    }
    ...
    static boolean ge(@NonNull Timestamp value0, Object value1) {
        if (value1 instanceof Timestamp) {
            return !value0.before((Timestamp) value1);
            ...
            return !dateValue0.before((Date) value1);
        }
        return false;
    }
