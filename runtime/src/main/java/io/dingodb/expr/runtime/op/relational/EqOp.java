...
abstract class EqOp extends RelationalOp {
    ...
    static boolean eq(@NonNull Date value0, Date value1, ExprConfig config) {
    ...
    static boolean eq(@NonNull Time value0, Time value1, ExprConfig config) {
        /*DingoTimeZoneProcessor processor = config.getProcessor();
    ...
    static boolean eq(@NonNull Timestamp value0, Timestamp value1, ExprConfig config) {
        /*DingoTimeZoneProcessor processor = config.getProcessor();
